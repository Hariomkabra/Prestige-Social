...
# Use dj_database_url for database configuration in production
# Wrapped in try/except to work in development without the package
try:
    ...
    pass  # dj_database_url not installed, using default database settings
